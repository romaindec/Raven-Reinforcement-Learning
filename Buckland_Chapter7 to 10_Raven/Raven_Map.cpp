...
void Raven_Map::Clear()
{
  ...
  //delete the reinforcement learning
  //delete m_pReinforcementLearning;
...
{  
  ...
  m_pReinforcementLearning = new ReinforcementLearning(m_pNavGraph->getNodes(), m_pNavGraph->getEdges());
  m_pReinforcementLearning->ReadTransitionMatrixInFile();
  return true;
}
