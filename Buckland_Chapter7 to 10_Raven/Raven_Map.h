...
private:
  ...
  //the reinforcement learning for that map
  ReinforcementLearning*			 m_pReinforcementLearning;
...
public:
  ...
  ReinforcementLearning*			 GetReinforcementLearning()const{return m_pReinforcementLearning;}
